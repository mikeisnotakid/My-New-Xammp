...
<head>
  ...
  <?php include 'dashboard-logic.php'; ?>
<body>
  ...
  <header class="header container">
    ...
    <div class="user">
      ...
      <div class="cart">
        ...
        <i style="font-size: 25px; color: red; font-weight:bolder ; margin-left: -15px;"></i>
      </div>
    ...
    <button onclick="openClose()" class="btn-mobile-nav">
      ...
      <i id="close-nav" class="fa fa-times icon-mobile-nav close" aria-hidden="true"></i>
        ...
        <form action="log_out.php" method="POST">
          <button name="logOutBtn" class="logout-btn-mobile" href='sign_in.php'>
            Log Out
          </button>
        </form>
  </header>
      ...
      <section class="dashboard">
        <div class="dash-top">
          ...
          <div class="balance">
            ...
            <div class="wall-text">
              <span>Balance:</span>
              <span class="bal-num"> $<?php viewbalance(); ?> </span>
            </div>
          </div>
        </div>
